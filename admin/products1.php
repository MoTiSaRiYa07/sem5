			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						...
						<span class="float:right"><a class="btn btn-primary btn-block btn-sm col-sm-2 float-right" href="index1.php?page=manage_product" id="new_product">
...
<script>
	...
	$('.edit_product').click(function(){
		location.href ="index1.php?page=manage_product1&id="+$(this).attr('data-id')
